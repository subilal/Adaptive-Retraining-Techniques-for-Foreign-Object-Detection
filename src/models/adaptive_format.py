...
"""
Date: 2023
Description: Code to train and deploy the machine learning more foreign object detection.
"""
...
def main()-> None:
  ...
  for Split_index in range(num_splits):
      #Define parameters for YOLO models
      ...
      # Yolo model definition and training
      ...
      # Evaluate  trained model of a test dataset
      ...
      # Validation perfromance Evaluation
      data = {
      'class': [],
      'P': [],
      'R': [],
